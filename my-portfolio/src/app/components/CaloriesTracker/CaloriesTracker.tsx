...
export default function CaloriesTracker({ project }: Props) {
    return (
        <section className="bg-[linear-gradient(115deg,#2cb32c,#81f759)] min-h-screen flex items-center justify-center">
            <div className="flex gap-10 items-center px-6 md:px-8 lg:px-16 pt-10 pb-20 h-full text-white">
